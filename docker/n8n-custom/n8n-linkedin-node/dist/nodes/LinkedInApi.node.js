...
class LinkedInApi {
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            try {
                const response = await axios_1.default.post(`${baseUrl}${endpoint}`, body, {
                    headers: {
                        'x-api-key': apiKey,
...
exports.LinkedInApi = LinkedInApi;
//# sourceMappingURL=LinkedInApi.node.js.map